	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
							...
							<ul class="pagination">
								<c:if test="${pages.currpageNo > 1}">
									<li class="paginate_button previous"><a
										href="${pageContext.request.contextPath}/list?currpageNo=1"
										aria-controls="datatable-responsive" data-dt-idx="0"
										tabindex="0">首页</a>
									</li>
									<li class="paginate_button "><a
										href="${pageContext.request.contextPath}/list?currpageNo=${pages.currpageNo-1}"
								...
								<c:if test="${pages.currpageNo < pages.totalPageCount }">
									...
									<li class="paginate_button next"><a
										href="${pageContext.request.contextPath}/list?currpageNo=${pages.totalPageCount }"
